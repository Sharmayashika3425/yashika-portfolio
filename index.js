...
ScrollReveal().reveal('.home-img,.services-container,.about-contant, .portfolio-box, .contact form', { origin:'bottom' });
ScrollReveal().reveal('.home-content h1, .about-img',{ origin:'left' });
ScrollReveal().reveal('.home-content p, .about-contant',{ origin:'right' });

// typed js............................
const typed =new Typed('.muliple-text',{
strings:['Software Developer','Web Developer(MERN Stack)','Data Science'],
typeSpeed:100,
backSpeed:100,
backDelay:1000,
loop:true,
